...
export default function ContactPage() {
  return (
    <main className="space-y-8">
      ...
      <section className="rounded-[2rem] border border-amber-300/20 bg-gradient-to-br from-amber-400/10 via-white/5 to-emerald-400/10 p-8 md:p-10">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-7 text-white/72 md:text-base">
          This portfolio uses Next.js App Router, reusable TypeScript components, extracted data modules, and standards-compliant metadata for production-ready hosting.
        </p>
      </section>
    </main>
  );
