...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${inter.className} min-h-screen bg-neutral-100 text-neutral-900 selection:bg-amber-400 selection:text-neutral-950 dark:bg-neutral-950 dark:text-white`}>
        <script
        ...
        />
        <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(245,158,11,0.2),transparent_26%),radial-gradient(circle_at_80%_20%,rgba(16,185,129,0.2),transparent_22%),linear-gradient(to_bottom,#fdfdfd,#f5f5f5)] dark:bg-[radial-gradient(circle_at_top,rgba(245,158,11,0.13),transparent_28%),radial-gradient(circle_at_80%_20%,rgba(16,185,129,0.14),transparent_24%),linear-gradient(to_bottom,#080808,#111111)]" />
