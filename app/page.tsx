        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/5 p-7">
          ...
          <div className="space-y-4">
            {featuredProjects.map((project) => (
              <Link key={project.title} href="/projects" className="group block rounded-[1.5rem] border border-white/10 bg-neutral-900/60 p-4 transition hover:border-amber-300/30">
